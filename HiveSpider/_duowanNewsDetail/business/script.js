...
setTimeout(function(){
    ...
    try{
        TemplateData.created_at = new Date(document.querySelector(".art-time").innerText).getTime();
        TemplateData.title = document.querySelector(".art-title").innerText
        TemplateData.url = window.location.href;
        TemplateData.article = BeeUtils.htmlToJson(document.getElementsByClassName("newsCont")[0]);
        var comment_list = document.querySelectorAll(".dw-comment-comment_list li .comment_text");
