require([
    ...
    const LIST_BEE_NAME = "janshu_index_update";
    const DETAIL_BEE_NAME = "jianshu_index_detail";
    ...
    const runTask = async() => {
        ...
        try {
            ...
            let indexUrl = "https://www.jianshu.com/trending/weekly?utm_medium=index-banner-s&utm_source=desktop";
